				...
				<div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a class="btn btn-primary btn-sm" href="{{ url('customer/pagecreate') }}"><i class="fa fa-user-plus"></i> New Customer</a>
                            ...
                            @foreach ($customers as $customer)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-success btn-xs" href="{{url('customer/pageedit',$customer->customer_id)}}">
                                            <span class="fa fa-edit"></span> Edit
                                        </a>
                                        <a data-name="{{$customer->name}}" data-href="{{url('customer/delete',$customer->customer_id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-xs">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure want to delete customer <span id="name-customer-delete" class="text-bold"></span></p>
