			...
			<div class="col-md-9 col-md-offset-1">
				...
				<div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Info supplier</h3>
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form class="form-horizontal" id="form-supplier" action="{{Asset('supplier/create')}}" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group @if ($errors->has('representative')) has-error @endif">
                                    <label for="representative" class="col-sm-2 control-label">Representative</label>

                                    <div class="input-group col-sm-10">
                                        <span class="input-group-addon"><i class="fa fa-street-view"></i></span>
                                        <input type="text" id="representative" name="representative" class="form-control" placeholder="Representative">
                                    </div>
                                    <div class="col-sm-offset-2">
                                        @if ($errors->has('representative'))<span class="help-block">{!!$errors->first('representative')!!}</span>@endif
                                    </div>
                                    <!-- /.input group -->
